...
maxrbq.plot1 = function(df,name){
   for (distance in c("euklid","winkel","winkellog")){
    ...
    jpeg(filename = filename,units="in",width=5,height=5,res=300)
    myplot <- ggplot(df.sub, aes(y=max.rbq, x= Block.f)) + geom_boxplot()
    print(myplot)
    dev.off()
   }
}
maxrbq.plot2 = function(df,name){
   for (distance in c("euklid","winkel","winkellog")){
    ...
    jpeg(filename = filename,units="in",width=5,height=5,res=300)
    myplot <- ggplot(df.sub, aes(y=max.rbq, x= Video)) + geom_boxplot()
    print(myplot)
    dev.off()
   }
}
maxqbr.plot1  = function(df,name){
   for (distance in c("euklid","winkel","winkellog")){
    ...
    jpeg(filename = filename,units="in",width=5,height=5,res=300)
    myplot <- ggplot(df.sub, aes(y=max.qbr, x= Block.f)) + geom_boxplot()
    print(myplot)
    dev.off()
   }
}
maxqbr.plot2  = function(df,name){
   for (distance in c("euklid","winkel","winkellog")){
    ...
    jpeg(filename = filename,units="in",width=5,height=5,res=300)
    myplot <- ggplot(df.sub, aes(y=max.qbr, x= Video)) + geom_boxplot()
    print(myplot)
    dev.off()
   }
}
maxdistance.plot1  = function(df,name){
   for (distance in c("euklid","winkel","winkellog")){
    ...
    jpeg(filename = filename,units="in",width=5,height=5,res=300)
    myplot <- ggplot(df.sub, aes(y=max.distance, x= Block.f)) + geom_boxplot()
    print(myplot)
    dev.off()
   }
}
maxdistance.plot2  = function(df,name){
   for (distance in c("euklid","winkel","winkellog")){
    ...
    jpeg(filename = filename,units="in",width=5,height=5,res=300)
    myplot <- ggplot(df.sub, aes(y=max.distance, x= Video)) + geom_boxplot()
    print(myplot)
    dev.off()
   }
}
mindistance.plot1  = function(df,name){
   for (distance in c("euklid","winkel","winkellog")){
    ...
    jpeg(filename = filename,units="in",width=5,height=5,res=300)
    myplot <- ggplot(df.sub, aes(y=min.distance, x= Block.f)) + geom_boxplot()
    print(myplot)
    dev.off()
   }
}
mindistance.plot2  = function(df,name){
   for (distance in c("euklid","winkel","winkellog")){
    ...
    jpeg(filename = filename,units="in",width=5,height=5,res=300)
    myplot <- ggplot(df.sub, aes(y=min.distance, x= Video)) + geom_boxplot()
    print(myplot)
    dev.off()
   }
}
...
histogramm.bins.plot  = function(df,name){
   for (distance in c("euklid","winkel","winkellog")){
    df.sub = subset(df,Distancemeasure == distance)
    desk <- by(df.sub$total_distance, list(df.sub$Block.f, df.sub$speed.f), describe)
    tmp.desk <- do.call(rbind.data.frame, desk)
    tmp.desk$Block <- c("Spot", "SL", "CL","Spot", "SL", "CL")
    tmp.desk$speed <- c("langsam","langsam","langsam","schnell","schnell","schnell")
    filename = paste0(name,"_",distance,"_","histogramm_bins.jpeg")
...
histogramm.bins.plot(sp.120.DTW,"DTW_120Hz")
histogramm.bins.plot(sp.120.FDTW,"FDTW_120Hz")
histogramm.bins.plot(sp.500.FDTW,"FDTW_500Hz")
