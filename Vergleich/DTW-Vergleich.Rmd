...
boxplot1 = function(df,name){
  for (distance in c("euklid","winkel","winkellog")){
    df.sub = subset(tmp,Distancemeasure == distance)
    ...
    myplot <- ggplot(tmp.sub, aes(y=total_distance, x= Block.f, color = speed.f)) + geom_boxplot() + 
...
boxplot2 = function(df,name){
  for (distance in c("euklid","winkel","winkellog")){
    ...
    jpeg(filename = filename,units="in",width=5,height=5,res=300)
    myplot <- ggplot(tmp.sub, aes(y=mean_distance, x= Block.f, color = speed.f)) + geom_boxplot() + 
...
boxplot3 = function(df,name){
  for (distance in c("euklid","winkel","winkellog")){
    ...
    jpeg(filename = filename,units="in",width=5,height=5,res=300)
    myplot <- ggplot(tmp.sub, aes(y=median_distance, x= Block.f, color = speed.f)) + geom_boxplot() + 
